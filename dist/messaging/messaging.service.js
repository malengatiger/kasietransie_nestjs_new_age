...
let MessagingService = class MessagingService {
    ...
    async send(topic, title, body, type, data, associationId) {
        ...
        try {
            ...
            const err = new kasie_error_1.KasieError(555, `${type} Message Send Failed`, new Date().toISOString());
...
exports.MessagingService = MessagingService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(AssociationToken_1.AssociationToken.name)),
