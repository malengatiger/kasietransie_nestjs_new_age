...
export declare class CloudStorageUploaderService {
    ...
    uploadVehiclePhoto(vehicleId: string, filePath: string, thumbFilePath: string, latitude: number, longitude: number): Promise<VehiclePhoto>;
    uploadFuelBrandLogo(fuelBrandId: string, filePath: string): Promise<string>;
    ...
    uploadReceiptFile(associationId: string, filePath: string): Promise<any>;
