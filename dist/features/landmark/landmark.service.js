...
let LandmarkService = class LandmarkService {
    constructor(configService, landmarkModel) {
        this.configService = configService;
        this.landmarkModel = landmarkModel;
    }
    async addBasicLandmark(landmark) {
        return null;
    }
    async deleteLandmark(landmarkId) {
        return null;
    }
    async findLandmarksByLocation(latitude, longitude, radiusInKM) {
        return [];
    }
};
...
exports.LandmarkService = LandmarkService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)(Landmark_1.Landmark.name)),
    __metadata("design:paramtypes", [config_1.ConfigService, mongoose_2.default.Model])
], LandmarkService);
//# sourceMappingURL=landmark.service.js.map