...
let MongoIndexBuilder = class MongoIndexBuilder {
    ...
    static async buildIndexes(client) {
        ...
        try {
            ...
            common_1.Logger.log(`${tag} 🌼 🌼 🌼 21 MongoDB Atlas indexes created successfully!  🌼\n\n`);
        }
        catch (error) {
