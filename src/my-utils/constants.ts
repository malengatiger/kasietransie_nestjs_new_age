export class Constants {
  public static readonly COMMUTER = 'COMMUTER';
  public static readonly MARSHAL = 'MARSHAL';
  public static readonly AMBASSADOR = 'AMBASSADOR';
  public static readonly ASSOCIATION_OFFICIAL = 'ASSOCIATION_OFFICIAL';
